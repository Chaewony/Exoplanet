	...
	XMFLOAT4 spotDiffuseColor[], XMFLOAT4 lightPosition[])
{
	...
	dataPtr5->diffuseColor[0] = spotDiffuseColor[0];
	dataPtr5->diffuseColor[1] = spotDiffuseColor[1];
	dataPtr5->diffuseColor[2] = spotDiffuseColor[2];
	dataPtr5->diffuseColor[3] = spotDiffuseColor[3];
